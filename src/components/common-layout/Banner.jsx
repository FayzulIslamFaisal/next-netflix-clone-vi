          ...
          {(randomMedia.name ||
            ...
            <div className="absolute inset-0 flex items-center justify-center flex-col bg-black/40 ">
              <div className="container mx-auto text-white text-center p-4">
                ...
                <p className="text-zinc-200 max-w-[800px] mx-auto">
                ...
                <div className="flex space-x-4 mt-6 justify-center">
                  <button
                    onClick={() =>
                      router.push(
                        `/watch/${randomMedia.mediaType}/${randomMedia.id}`
                      )
                    }
                    className="bg-white text-black px-6 py-2 rounded flex items-center gap-2 cursor-pointer ring-2"
                  >
                    <AiFillPlayCircle className="mr-2" />
                    <span>Play</span>
                  </button>
                  <button className="bg-transparent text-white px-6 py-2 rounded flex items-center gap-2 cursor-pointer ring-2">
